...
You can also annotate using the "verbose" mode (command line option `-v`), this makes SnpEff show a lot of information which can be useful for debugging.
...
00:00:00.434	done
00:00:00.434	Reading database for genome version 'GRCh37.75' from file './data/GRCh37.75/snpEffectPredictor.bin' (this might take a while)
...
00:00:00.655	Downloading from 'https://snpeff-public.s3.amazonaws.com/databases/v5_0/snpEff_v5_0_GRCh37.75.zip'
.............................................
00:01:31.595	Download finished.
00:01:31.597	Extracting file 'data/GRCh37.75/motif.bin'
...
00:01:58.779	done
00:01:58.813	Reading NextProt database
...
!!! info
    You can use the `-configOption` command line option to override any value in the config file, e.g. `-configOption data.dir=/my/data/dir`.
...
```
./scripts/snpEff GRCh37.75 examples/test.chr22.vcf > test.chr22.ann.vcf
```

The wrapper defaults to `-Xms1g -Xmx8g` and auto-detects the `snpEff.config` file location. You can override the memory settings by passing `-Xmx` explicitly.
...
E.g. In this example we use 4Gb:

```
# Run using 4 Gb of memory
java -Xmx4g -jar snpEff.jar hg19 path/to/your/files/snps.vcf
```
...
You can run SnpEff in the Cloud exactly the same way as running it on your local computer.
