...
public final class FastqBuilder {
	...
	public Fastq build() {
		...
		if( sequence == null ) { throw new IllegalStateException("sequence must not be null"); }
		if( quality == null ) { throw new IllegalStateException("quality must not be null"); }
		if( variant == null ) { throw new IllegalStateException("variant must not be null"); }
		if( !sequenceAndQualityLengthsMatch() ) { throw new IllegalStateException("sequence and quality scores must be the same length"); }
