 ...
 *
 */
public class ZzzHydrogenBonds {

    String fileName;
    Structure structure;

    public ZzzHydrogenBonds(String fileName) {
        this.fileName = fileName;
    }

    public static void main(String args[]) throws Exception {
        Log.info("Start");
        ZzzHydrogenBonds zzz = new ZzzHydrogenBonds("tests/integration/zzz/pdb/pdb5pti.ent.gz");
        zzz.load();
        zzz.show();
        Log.info("End");
    }
