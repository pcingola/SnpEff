...
public class TestCasesAnn extends TestCasesBase {
	...
	public void test_01_Annotation_Stop() {
		Gpr.debug("Test");
		String vcfFile = "tests/integration/ann/test_ann_01.vcf";
	...
	public void test_01_VcfRawAlt() {
		...
		// Create command
		String args[] = { "testHg3775Chr1", "tests/integration/ann/test_ann_integration_01.vcf" };
	...
	public void test_02_Annotation_SpliceRegion() {
		Gpr.debug("Test");
		String vcfFile = "tests/integration/ann/test_ann_02.vcf";
	...
	public void test_03_Annotation_NonSyn() {
		Gpr.debug("Test");
		String vcfFile = "tests/integration/ann/test_ann_03.vcf";
	...
	public void test_04_Annotation_Intergenic() {
		Gpr.debug("Test");
		String vcfFile = "tests/integration/ann/test_ann_04.vcf";
