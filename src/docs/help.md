...
!!!warning
    **Important:** In order to assess your problem precisely, I must be able to reproduce your example.
...
Results      | What you expect to obtain | "we wanted to get information on variants that affect splice regions..."
...
* **Ask for too much advice.** I don't mind helping, I've been doing it forever.
      However I won't be able to help you with all the details (due to limited bandwidth), so most times, the best I can do is to provide some pointers and general advise you can follow up on.
...
Item         | Explanation     | Example
------------ | --------------- | ---------
What?        | A clear explanation of the bug condition.<br>Please copy the full stack trace if one is available.| "a RuntimeException occurs when trying to annotate..."
